...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
        ...
        when(p0!!.id){
            ...
            R.id.tv_select_current_location ->{
                if(!isLocationEnabled()){
                    Toast.makeText(this, "Your Location Provider is Turned Off. Please Turn ON your Location Provider", Toast.LENGTH_SHORT).show()
            ...
            if(requestCode == GALLERY){
                if(data != null){
                    ...
                    try {
                        ...
                        e.printStackTrace()
                        Toast.makeText(this@AddHappyPlaceActivity, "Failed To Load Image From Gallery!", Toast.LENGTH_SHORT)
                    }
                }
    ...
    private fun showRationalDialogForPermissions(){
        AlertDialog.Builder(this).setMessage("It Looks Like You Have Turned OFF Permission Required For This Feature. It Can Be Unabled Under The Application Setting.")
